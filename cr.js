let months = prompt("Enter number of months(1-19):-");
...
newButton.textContent = "Start " + months +" months loop of all cities";
...
function checkCity(m){
    ...
    switch (cityIndex) {
        case 1: desiredCityDropdownValue = "c86af614-b0db-ec11-a7b4-001dd80234f6"; break;//chennai
        case 2: desiredCityDropdownValue = "ae6af614-b0db-ec11-a7b4-001dd80234f6"; break;//hyderabad
        case 3: desiredCityDropdownValue = "816af614-b0db-ec11-a7b4-001dd80234f6"; break;//kolkata
        case 4: desiredCityDropdownValue = "716af614-b0db-ec11-a7b4-001dd80234f6"; break;//mumbai
        case 5: desiredCityDropdownValue = "e66af614-b0db-ec11-a7b4-001dd80234f6"; break;//delhi
    ...
    waitForDatepickerClass().then(() => {
        ...
        function checkMonthAndClickNext() {
            ...
            if (nextMonthClickCounter < months) {
                        ...
                        if (nextButton) {
                            ...
                            if (nextMonthClickCounter == months) {
                                ...
                                //console.log(cityIndex);
                                    ...
                                    if(cityIndex < 5){
                                        cityIndex++;
                                        nextMonthClickCounter = undefined;
                                        checkCity(cityIndex);
                                    }else{nextMonthClickCounter = undefined;checkCity(1);}
                                    // checkCity(1)
